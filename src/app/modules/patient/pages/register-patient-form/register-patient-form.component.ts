...
import { Address } from 'src/app/data/model/entities/Address';
import { Gender, Patient } from 'src/app/data/model/entities/Patient';
...
export class RegisterPatientFormComponent {
  ...
  public set setPatientGender(gender: string) {
    if (gender.toLowerCase() == 'female')
      this.patientProfile.gender = Gender.FEMALE;
    else
      this.patientProfile.gender = Gender.MALE;
  }
}
