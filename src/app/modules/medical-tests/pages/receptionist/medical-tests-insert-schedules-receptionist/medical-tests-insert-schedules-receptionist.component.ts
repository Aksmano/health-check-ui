...
export class MedicalTestsInsertSchedulesReceptionistComponent implements OnInit, OnDestroy {
  ...
  constructor(private readonly medicalTestScheduleService: MedicalTestSchedulesService,
  ...
  ngOnInit(): void {
    this.activatedRoute.params.subscribe(params => {
      ...
      this.dateSubscription = this.dateSubscription = this.currentDate$.subscribe(data => {
        ...
        } as MedicalTestScheduleCriteriaQP).subscribe(data => {
